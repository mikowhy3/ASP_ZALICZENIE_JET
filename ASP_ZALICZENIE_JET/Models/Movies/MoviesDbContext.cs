...
public partial class MoviesDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MovieCast>(entity =>
        {
            modelBuilder.Entity<MovieCast>(entity =>
            {
                ...
                entity.HasOne(d => d.Movie)
                    .WithMany(m => m.MovieCasts)  // MovieCasts w Movie
                    .HasForeignKey(d => d.MovieId)
                    .OnDelete(DeleteBehavior.Cascade);

                entity.HasOne(d => d.Person)
                    .WithMany(p => p.MovieCasts)  // MovieCasts w Person
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            // Relacja wiele do wielu z Movie poprzez MovieCast
            entity.HasMany(p => p.Movies)
                ...
                .UsingEntity<MovieCast>(
                    ...
                    j =>
                    {
                        ...
                        j.Property(mc => mc.CharacterName).HasColumnName("character_name");
                        j.Property(mc => mc.CastOrder).HasColumnName("cast_order");
                        j.Property(mc => mc.GenderId).HasColumnName("gender_id");
                    });
        });
